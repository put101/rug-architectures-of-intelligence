...
# It plays the game based on the settings of the global variables
...
# learning requires one parameter which is how many 100 hand
# games to play.  There are two optional parameters which
